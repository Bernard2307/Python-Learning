#COLOCAR OS DADOS DE CADA LINHA DA PLANILHA NO CONTRATO
...
planilha = load_workbook('fornecedores.xlsx') #carregando a planilha
pagina_fornecedores = planilha['Sheet1']
...
for linha in pagina_fornecedores.iter_rows(min_row= 2, values_only=True):
    ...
    CONTRATANTE: BLDNA TECH SA 
    E-mail: bldnatechsa@gmail.com

    Petrolina, {datetime.now().strftime('%d/%m/%Y')}
"""
